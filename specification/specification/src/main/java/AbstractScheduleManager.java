...
public abstract class AbstractScheduleManager {
    ...
    public abstract void setTermProperty1(String roomId, Date startDate, Date endDate, String day, String time, String propertyKey, Object propertyValue);
    ...
    //Ispisi
    public abstract void printOutRooms();
    public abstract void printOutTerm();
    public abstract void ispisi(List<Map<String, Object>> mapa);
